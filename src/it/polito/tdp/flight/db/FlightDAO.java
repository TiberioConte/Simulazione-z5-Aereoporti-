...
public class FlightDAO {
	...
	public List<Airport> getAllAirports(AirportIdMap mappaAirport) {
		...
		try {
			...
			while (res.next()) {
				Airport a=mappaAirport.get(res.getInt("Airport_ID"));
				if(a==null){
				a=new Airport(res.getInt("Airport_ID"), res.getString("name"), res.getString("city"),
